...
# --- PHASE 3: EVALUATION (LOSEN, LESEN & FRAGEBOGEN) ---
    ...
    if st.session_state.aktuelles_transkript_file is None:
        ...
        col_left, col_right = st.columns([1, 1.2]) # Verhältnis der Spaltenbreite (links etwas schmaler)
        ...
        with col_left:
            ...
            # Der HTML-Container behält seine feste Höhe und bleibt scrollbar
            st.markdown(
                f"""
                <div style="background-color: #f9f9f9; color: #111111; padding: 20px; border-radius: 8px;
                            border: 1px solid #e0e0e0; height: 750px; overflow-y: scroll;
        ...
        with col_right:
            ...
            # Hier betten wir das Formular in einen scrollbaren Container ein
